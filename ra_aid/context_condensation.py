...
# Default models for different condensation quality levels
...
def get_condenser_model_for_quality(
    ...
    if quality == "fast":
        return DEFAULT_FAST_CONDENSER_MODEL, None
    elif quality == "advanced":
        return DEFAULT_ADVANCED_CONDENSER_MODEL.split("/")[1], DEFAULT_ADVANCED_CONDENSER_MODEL.split("/")[0]
    else:  # balanced
        return DEFAULT_BALANCED_CONDENSER_MODEL, None
